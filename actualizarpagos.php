		...
		<div class="row justify-content-center">
			<div class="col-md-6 col-md-offset-3" align="center">
				...
				<br>
					...
					<form style="margin: auto;" method="post" action="actualizarpago_be.php" enctype="multipart/form-data">
                ...
                <option value="0">No Pagado</option>
                    ...
                    <br>
					<input type="submit" name="enviardatos" value="Actualizar Datos" style="background-color: #450d16; color: white; border-radius: 10px;">
					<br>
					<br>

	...
	<div class="container" style="margin:auto; width: auto;">
		<div class="row justify-content-left">
			<div class="col-md-6 col-md-offset-3" align="center">
				...
				<form method="post" action="consultoria" enctype="multipart/form-data">
		...
		<div style="background-color: white; width: 450px; ; border-radius: 5px; margin-left: 500px; margin-top:-450px;">
		    <h3 style="text-align: center; background-color: #007bff; color: white; padding-top: 10px; border-radius: 5px;">Instrucciones</h3>
